...
@Module({
  imports: [PrismaModule, UserModule, AuthModule, RoleModule, ProductModule, DeliveryModule, ShopModule, InventoryModule, OrderModule, TransactionModule, ReportModule],
